...
(function (W, O, s) {
  ...
  function ec(b) {
    ...
    "function" == typeof b
      ? (a = b.$inject) ||
        ...
        (b.$inject = a))
      : K(b)
      ? ((c = b.length - 1), Na(b[c], "fn"), (a = b.slice(0, c)))
      : Na(b, "fn", !0);
    return a;
  }
  function Yb(b) {
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (l.pushState(null, "", a), G.attr("href", G.attr("href")))
              : ((t = a), c ? k.replace(a) : (k.href = a)),
            h
          );
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === s
          ...
          : D(b) &&
            ((d =
              (m.cookie = escape(a) + "=" + escape(b) + ";path=" + ba).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[f]),
              ...
              0 < h &&
                ...
                Y[a] === s && (Y[a] = unescape(e.substring(h + 1))));
        return Y;
      }
    };
      ...
      function b(b, d) {
        ...
        return (a[b] = {
          put: function (a, b) {
            ...
            e(c);
            if (!y(b))
              return a in m || g++, (m[a] = b), g > k && this.remove(r.key), b;
          },
          get: function (a) {
            var b = l[a];
            if (b) return e(b), m[a];
    ...
    this.$get = [
      ...
      function (b, l, n, r, q, z, J, Q, v, B, G) {
        ...
        function Z(a, b, c, d, e, f) {
          function h(a, c, d, e) {
            ...
            for (r = g.length; q < r; z++)
              (k = da[z]),
                ...
                c
                  ? (c.scope
                      ? ((n = a.$new()), l.data("$scope", n), ha(l, "ng-scope"))
                      : (n = a),
                    (l = c.transclude) || (!e && b)
                      ? c(f, n, k, d, Y(a, l || b))
                      : c(f, n, k, s, e))
          ...
          for (var g = [], k, l, n, q = 0; q < a.length; q++)
            (l = new Db()),
              (k = X(a[q], [], l, 0 === q ? d : s, e)),
              (k =
                ((f = k.length
                  ? wa(k, a[q], l, b, c, null, [], [], f)
                  : null) &&
                  f.terminal) ||
                !a[q].childNodes ||
                !a[q].childNodes.length
                  ? null
                  : Z(a[q].childNodes, f ? f.transclude : b)),
              g.push(f),
              g.push(k),
              (n = n || f || k),
              (f = null);
            ...
            case 8:
              try {
                if ((k = d.exec(a.nodeValue)))
                  (q = ma(k[1])), ia(b, q, "M", f, h) && (c[q] = aa(k[2]));
              } catch (p) {}
          }
          b.sort(w);
          return b;
        ...
        function wa(a, b, c, d, e, f, h, g, k) {
          ...
          function B(a, d, e, f, k) {
            ...
            if (v) {
              ...
              f = x(e);
              I = d.$new(!0);
              Y && Y === v.$$originalDirective
                ? f.data("$isolateScope", I)
                : f.data("$isolateScopeNoTemplate", I);
          ...
          for (
            ...
            if ((M = H.scope))
              (G = G || H),
                H.templateUrl ||
                  (y("new/isolated scope", v, H, V), U(M) && (v = H));
            w = H.name;
            !H.templateUrl &&
              H.controller &&
              ((M = H.controller),
              (Z = Z || {}),
              y("'" + w + "' controller", Z[w], H, V),
              (Z[w] = H));
            if ((M = H.transclude))
              (wa = !0),
                H.$$tlb || (y("transclusion", k, H, V), (k = H)),
                "element" == M
                  ? ((ia = !0),
                    (Q = H.priority),
                    (M = ba(b, N, fb)),
                    (V = c.$$element =
                      x(O.createComment(" " + w + ": " + c[w] + " "))),
                    (b = V[0]),
                    R(e, x(ta.call(M, 0)), b),
                    (u = t(M, d, Q, f && f.name, {
            ...
            if (H.template)
              if (
                (y("template", Y, H, V),
                (Y = H),
                (M = E(H.template) ? H.template(V, c) : H.template),
                (M = hc(M)),
                H.replace)
              ) {
                f = H;
            ...
            if (H.templateUrl)
              y("template", Y, H, V),
                (Y = H),
                H.replace && (f = H),
                (B = C(a.splice(F, a.length - F), V, c, e, u, h, g, {
              ...
              try {
                (A = H.compile(V, c, u)),
                  E(A) ? q(null, A, N, fb) : A && q(A.pre, A.post, N, fb);
              } catch (W) {
                n(W, ga(V));
              }
        ...
        function ia(d, e, f, h, g, l, q) {
          ...
          if (a.hasOwnProperty(e)) {
            var r;
            e = b.get(e + c);
            for (var z = 0, t = e.length; z < t; z++)
              try {
                (r = e[z]),
                  (h === s || h > r.priority) &&
                    -1 != r.restrict.indexOf(f) &&
                    (l && (r = Rb(r, { $$start: l, $$end: q })),
                    d.push(r),
                    (g = r));
              } catch (J) {
                n(J);
        ...
        function C(a, b, c, d, e, f, h, k) {
          ...
          b.html("");
          r.get(B.getTrustedResourceUrl(Q), { cache: q })
            .success(function (q) {
              var r, B;
              q = hc(q);
              if (t.replace) {
                ...
                r = q[0];
                if (1 != q.length || 1 !== r.nodeType)
                  throw ja("tplrt", t.name, Q);
                q = { $attr: {} };
                R(d, b, r);
                var G = X(r, [], q);
                U(t.scope) && S(G);
                  ...
                  pre: function (b, c, f) {
                    ...
                    if ((e = l(f[d], !0, F(a, d))))
                      (f[d] = e(b)),
                        ((c[d] || (c[d] = [])).$$inter = !0),
                        (
                          (f.$$observers && f.$$observers[d].$$scope) ||
                          b
                        ).$watch(e, function (a) {
                          f.$set(d, a);
                        });
          ...
          $set: function (a, b, c, d) {
            ...
            if ("class" == a)
              (b = b || ""),
                ...
                this.$removeClass(e(c, b).join(" ")),
                this.$addClass(e(b, c).join(" "));
            else {
              ...
              d
                ? (this.$attr[a] = d)
                : (d = this.$attr[a]) || (this.$attr[a] = d = bb(a, "-"));
              h = Fa(this.$$element);
      ...
      function (a, b, c, d, n, r) {
        ...
        function z(b, c, f) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (p = U(b.cache) ? b.cache : U(e.cache) ? e.cache : Q);
          if (p)
            if (((v = p.get(s)), C(v))) {
  ...
  function md(b, a, c, d, e, f) {
    ...
    return function (e, m, k, l, n, r, q, z) {
      ...
      if ("jsonp" == u(e)) {
        ...
        var G = g(
          m.replace("JSON_CALLBACK", "angular.callbacks." + B),
          function () {
        ...
        t.onreadystatechange = function () {
          if (4 == t.readyState) {
            ...
            Q(
              l,
              v || t.status,
              t.responseType ? t.response : t.responseText,
              a
            );
          }
        };
  ...
  function od() {
    ...
    this.$get = [
      ...
      function (c, d, e) {
        function f(f, k, l) {
          for (var n, r, q = 0, z = [], J = f.length, p = !1, v = []; q < J; )
            -1 != (n = f.indexOf(b, q)) && -1 != (r = f.indexOf(a, n + g))
              ? (q != n && z.push(f.substring(q, n)),
                z.push((q = c((p = f.substring(n + g, r))))),
                (q.exp = p),
                (q = r + h),
                (p = !0))
              : (q != J && z.push(f.substring(q)), (q = J));
          ...
          if (!k || p)
            return (
              ...
              (q = function (a) {
                try {
                  for (var b = 0, c = J, h; b < c; b++)
                    "function" == typeof (h = z[b]) &&
                      ((h = h(a)),
      ...
      function (b, a, c) {
        function d(d, g, h, m) {
          ...
          r.$$intervalId = k(function () {
            ...
            0 < h &&
              q >= h &&
              (n.resolve(q), l(r.$$intervalId), delete e[r.$$intervalId]);
            z || b.$apply();
          }, g);
          e[r.$$intervalId] = n;
          return r;
      ...
      function (c, d, e, f) {
        ...
        f.on("click", function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            for (var b = x(a.target); "a" !== u(b[0].nodeName); )
  ...
  function tc(b, a, c) {
    ...
    if (a.csp)
      f =
        6 > e
          ? sc(d[0], d[1], d[2], d[3], d[4], c, a)
          : function (b, f) {
              var h = 0,
                g;
              do
                (g = sc(d[h++], d[h++], d[h++], d[h++], d[h++], c, a)(b, f)),
                  (f = s),
                  (b = g);
              while (h < e);
              return g;
      ...
      function (c, d, e, f) {
        ...
        g.prototype = {
          ...
          $watch: function (a, b, c) {
            var d = m(a, "watch"),
              e = this.$$watchers,
              f = { fn: b, last: k, get: d, exp: a, eq: !!c };
            if (!E(b)) {
                    ...
                    try {
                      (c = g[s]) &&
                        ...
                        5 > G &&
                          ...
                          x[w] || (x[w] = []),
                          (C = E(c.exp)
                            ? "fn: " + (c.exp.name || c.exp.toString())
                            : c.exp),
                          (C += "; newVal: " + oa(e) + "; oldVal: " + oa(f)),
                          x[w].push(C)));
                    } catch (P) {
                      d(P);
                    }
  ...
  function Ad() {
    ...
    this.$get = [
      ...
      "$sceDelegate",
      function (a, c, d) {
        if (b && N && ((c = c[0].documentMode), c !== s && 8 > c))
          throw ra("iequirks");
        var e = fa(ea);
    ...
    this.$get = [
      ...
      function (b, a) {
        ...
        if (m) {
          ...
          !d ||
            (k && l) ||
            ((k = D(f.body.style.webkitTransition)),
            (l = D(f.body.style.webkitAnimation)));
        }
        return {
          history: !(!b.history || !b.history.pushState || 4 > d || e),
          hashchange:
            "onhashchange" in b && (!f.documentMode || 7 < f.documentMode),
          hasEvent: function (a) {
  ...
  function zc(b) {
    ...
    return function (b, d) {
      ...
      return Dc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
        /\u00A4/g,
        d
      );
    };
    ...
    return function () {
      return {
        ...
        link: function (c, d, e) {
          function f(b) {
            if (!0 === a || c.$index % 2 === a)
              h && !Ba(b, h) && e.$removeClass(g(h)), e.$addClass(g(b));
            h = fa(b);
          }
          function g(a) {
  ...
  isNaN(N) &&
    (N = R((/trident\/.*; rv:(\d+)/.exec(u(navigator.userAgent)) || [])[1]));
  w.$inject = [];
  Aa.$inject = [];
  var aa = (function () {
  ...
  var Sc = /[A-Z]/g,
    ...
    Wc = 1,
    Gc = W.document.addEventListener
      ? function (b, a, c) {
    ...
    zb = W.document.removeEventListener
      ? function (b, a, c) {
    ...
    Ea = (L.prototype = {
      ready: function (b) {
        ...
        "complete" === O.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), L(W).on("load", a));
      },
      toString: function () {
        var b = [];
        p(this, function (a) {
      ...
      function (a, c, d, e, f) {
        ...
        this.$setValidity = function (a, c) {
          n[a] !== !c &&
            (c
              ? (n[a] && l--,
                l || (g(!0), (this.$valid = !0), (this.$invalid = !1)))
              ...
              Ma(f)
                ? m ||
                  ...
                  g(m, function (c) {
                    h = {
                      startNode: c[0],
                      endNode: (c[c.length++] = O.createComment(
                        " end ngIf: " + e.ngIf + " "
                      )),
                    };
              ...
              h.$watch(g.parseAsResourceUrl(k), function (g) {
                ...
                g
                  ? (a
                    ...
                    h.$emit("$includeContentRequested"))
                  : t();
              });
            };
          },
          ...
          link: function (e, f, g, h, m) {
            ...
            e.$watchCollection(h, function (a) {
              ...
              if (ob(a)) (A = a), (n = r || q);
                ...
                A = [];
                for (D in a)
                  a.hasOwnProperty(D) && "$" != D.charAt(0) && A.push(D);
                A.sort();
              }
              y = A.length;
              h = F.length = A.length;
          ...
          link: function (e, g, h, m) {
            ...
            function n(e, f, g) {
              function h() {
                ...
                if (z)
                  if (t && K(u))
                    for (s = new Ra([]), I = 0; I < u.length; I++)
                      (y[m] = u[I]), s.put(t(e, y), u[I]);
                  else s = new Ra(u);
                for (I = 0; (F = A.length), I < F; I++) {
                  ...
                  z
                    ? (d = C(s.remove(t ? t(e, y) : q(e, y))))
                    : (t
                        ? ((d = {}), (d[m] = u), (d = t(e, d) === t(e, y)))
                        : (d = u === q(e, y)),
                      (s = s || d));
                  E = l(e, y);
                  E = C(E) ? E : "";
                    ...
                    (s = k[I]),
                      (d = x[I + 1])
                        ...
                        : ("" === s.id && w
                          ...
                          E ? E.after(J) : u.element.append(J),
                          (E = J));
